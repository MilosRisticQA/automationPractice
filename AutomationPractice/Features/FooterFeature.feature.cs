...
namespace AutomationPractice.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("FooterFeature")]
    public partial class FooterFeatureFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "FooterFeature", "\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the sum o" +
        ...
        public virtual void UserCanOpenLinksUnderMyAccountSection(string myAccount, string page, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User can open links under My Account section", null, @__tags);
#line 7
...
#line 10
 testRunner.And("users submits the login form", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 11
 testRunner.When(string.Format("user clicks on \'{0}\' option", myAccount), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 12
