...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User can open wishlist page", null, new string[] {
                        "MyAccount"});
#line 15
 this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User can create an account", null, new string[] {
                        "MyAccount"});
#line 24
 this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
